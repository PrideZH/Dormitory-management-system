...
public class SidebarBuilder {
	...
	private SidebarBuilder() {
		// 其他
		sidebarBtns.put("other", new SidebarBtn(Constant.OTHER_IMG, "其他", Constant.SIDEBAR_WIDTH));
		...
		// 个人中心
		sidebarBtns.put("personal", new SidebarBtn(Constant.PERSONAL_IMG, "个人中心", Constant.SIDEBAR_WIDTH));
		...
		// 楼宇管理
		sidebarBtns.put("building", new SidebarBtn(Constant.BUILDING_IMG, "楼宇管理", Constant.SIDEBAR_WIDTH));	
		...
		// 宿舍管理
		sidebarBtns.put("dorm", new SidebarBtn(Constant.DORM_GREY_IMG, "宿舍管理", Constant.SIDEBAR_WIDTH));
		...
		// 用户权限管理
		sidebarBtns.put("admin", new SidebarBtn(Constant.ADMIN_IMG, "用户权限管理", Constant.SIDEBAR_WIDTH));
		...
		// 学生管理
		sidebarBtns.put("student", new SidebarBtn(Constant.STUDENT_IMG, "学生管理", Constant.SIDEBAR_WIDTH));
